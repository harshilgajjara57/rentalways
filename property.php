...
<head>
    ...
    <link rel="stylesheet" href="admin/assets/vendors/bootstrap-5.0.2-dist/css/bootstrap.min.css">
    <script src="admin/assets/vendors/bootstrap-5.0.2-dist/js/bootstrap.bundle.min.js"></script>
...
?>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:480px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="assets/datas/spin.svg" />
        </div>
        ...
        ?>
            <div>
                <img data-u="image" src="assets/datas/<?php echo $row['filename']; ?>" />
                <img data-u="thumb" src="assets/datas/<?php echo $row['filename']; ?>" />
            </div>
        <?php
            }
        ?>
